    ...
    if (toolType === 'both') {
        ...
        $('.tool_navigation a').on('click', function(event) {
            ...
            if (activeTool === 'validation') {
                ...
                $('#submit_step2').attr('id', 'submit_step2Val');
                $('#submit_step2Val').on('click', function(){
                    $('#step2').hide();
                    $('#step5').show();
                ...
                $('#startValidation').on('click', function() {
                    $('#income_folder').empty();
                    $('#errors_table').empty();
                    var test = $("#file_type").val();
                    
                    B = "http://localhost:8080/rest/validate&fileType="+test;
                    console.log(B)
                    $.get(B, function(G) {
                        var I = G;
                        var H = 0;
                ...
                $('#submit_step2Val').attr('id', 'submit_step2');
