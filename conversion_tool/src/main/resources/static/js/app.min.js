$(document).ready(function() {
        ...
        $('.tool_navigation a').on('click', function(event) {
            ...
            if (activeTool === 'validation') {
                ...
                $('#startValidation').on('click', function() {
                    $('#income_folder').empty();
                    $('#errors_table').empty();
                    B = "http://localhost:8080/rest/validate";
                    $.get(B, function(G) {
                        var I = G;
                        var H = 0;
    ...
    function w() {
        ...
        if ($("#file_type").val() === "xml_ead") {
            B = "http://localhost:8080/rest/process?fileType=xml_ead";
            $.get(B, function(G) {
                var I = G;
                var H = 0;
                $.each(I.split("|"), function(K, L) {
            ...
            if ($("#mapping_type").val() === "generic" && C != "") {
                ...
                B = "http://localhost:8080/rest/process?fileType="+fileTypeParam+"?mapping=" + C;
                $.get(B, function(G) {
                    var I = G;
                    var H = 0;
                    $.each(I.split("|"), function(K, L) {
                ...
                if ($("#mapping_type").val() === "generic" && C === "") {
                    var fileTypeParam = $("#file_type").val();
                    B = "http://localhost:8080/rest/process?fileType="+fileTypeParam+"&organisation=" + F;
                    $("#errors_table").empty();
                    $.get(B, function(G) {
                        var I = G;
                        var H = 0;
                    ...
                    if ($("#mapping_type").val() === "specific") {
                        var fileTypeParam = $("#file_type").val();
                        B = "http://localhost:8080/rest/process?fileType="+fileTypeParam+"?xquery=" + E;
                        $.get(B, function(G) {
                            var I = G;
                            var H = 0;
                            $.each(I.split("|"), function(K, L) {
